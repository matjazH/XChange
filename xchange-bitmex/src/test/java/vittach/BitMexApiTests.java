...
public class BitMexApiTests {
  ...
  public void initializing() {
    ...
    ExchangeSpecification exchangesSpecifics = new ExchangeSpecification(BitMexExchange.class);

    exchangesSpecifics.setSslUri("https://bitmex.com/");
    ...
    //anyExchangeInstance= ExchangeFactory.INSTANCE.createExchange(BitMexExchange.class.getName());
  ...
  public void getPublicInfo() throws IOException {
    ...
    BitMexInfo allYoBitInfo = ((BitMexMarketDataService) pollingMarketDataService).getAllYoBitInfo();
