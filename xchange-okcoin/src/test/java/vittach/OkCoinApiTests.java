...
public class OkCoinApiTests {
  ...
  public void initializing() {
    ...
    ExchangeSpecification exchangesSpecifics = new ExchangeSpecification(OkCoinExchange.class);

    exchangesSpecifics.setSslUri("https://www.okcoin.com/api");
    ...
    //anyExchangeInstance=ExchangeFactory.INSTANCE.createExchange(OkCoinExchange.class.getName());
