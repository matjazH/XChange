...
public class YoBitTicker {
  ...
  public YoBitTicker(@JsonProperty("high") BigDecimal max, @JsonProperty("low") BigDecimal min,
  ...
  public String toString() {
    return "YoBitTicker {" + "max=" + max + ", min=" + min + ", last=" + last + ", bid=" + bid + ", ask=" + ask + ", vwap=" + vwap + ", average=" + average + ", volume=" + volume + '}';
  }
}
