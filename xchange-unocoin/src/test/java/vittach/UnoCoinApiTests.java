...
import org.knowm.xchange.unocoin.UnoCoinExchange;
 ...
 */
public class UnoCoinApiTests {
  private String result = "\n";
  private String orderId = "100025362";
  ...
  public void initializing() {
    ...
    ExchangeSpecification exchangesSpecifics = new ExchangeSpecification(UnoCoinExchange.class);

    exchangesSpecifics.setSslUri("https://UnoCoin.com/");
  ...
  public void placeLimitOrder() throws IOException {
    ...
    BigDecimal limitPrice = new BigDecimal(1);
    Date date = new Date();
  ...
  public void getPublicInfo() throws IOException {
    UnoCoinInfo allUnoCoinInfo = ((UnoCoinMarketDataService) pollingMarketDataService).getAllUnoCoinInfo();
    result += " - getPublicInformation \n" + allUnoCoinInfo.toString() + "\n";
  }
