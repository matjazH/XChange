...
public class UnoCoinTicker {
  ...
  public UnoCoinTicker(@JsonProperty("high") BigDecimal max, @JsonProperty("low") BigDecimal min,
  ...
  public String toString() {
    return "UnoCoinTicker {" + "max=" + max + ", min=" + min + ", last=" + last + ", bid=" + bid + ", ask=" + ask + ", vwap=" + vwap + ", average=" + average + ", volume=" + volume + '}';
  }
}
