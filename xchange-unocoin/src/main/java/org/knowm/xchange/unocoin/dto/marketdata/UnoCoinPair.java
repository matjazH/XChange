...
@JsonDeserialize(using = UnoCoinPairDeserializer.class)
public class UnoCoinPair {
  ...
  public UnoCoinPair(Integer decimal_places, BigDecimal min_price, BigDecimal max_price, BigDecimal min_amount,
  ...
  public String toString() {
    return "UnoCoinPair [decimal_places=" + decimal_places + ", min_price=" + min_price + ", max_price=" + max_price
        + ", min_amount=" + min_amount + ", min_total=" + min_total + ", hidden=" + hidden + ", fee=" + fee
        + ", fee_buyer=" + fee_buyer + ", fee_seller=" + fee_seller + "]";
  }

  static class UnoCoinPairDeserializer extends JsonDeserializer<UnoCoinPair> {
    ...
    public static UnoCoinPair deserializeFromNode(JsonNode tickerNode) {
      ...
      return new UnoCoinPair(decimal_places, min_price, max_price, min_amount, min_total, hidden, fee, fee_buyer,
          fee_seller);
    }

    @Override
    public UnoCoinPair deserialize(JsonParser jp, DeserializationContext ctxt)
