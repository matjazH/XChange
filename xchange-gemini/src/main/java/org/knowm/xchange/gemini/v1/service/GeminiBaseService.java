...
public class GeminiBaseService extends BaseExchangeService implements BaseService {
  ...
  public GeminiBaseService(Exchange exchange) {
    ...
    this.Gemini = RestProxyFactory.createProxy(GeminiAuthenticated.class, exchange.getExchangeSpecification().getSslUri(), createClientConfig(exchange.getExchangeSpecification()));
