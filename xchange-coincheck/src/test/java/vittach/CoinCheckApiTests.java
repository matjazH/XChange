 ...
 */
public class CoinCheckApiTests {
  private String result = "\n";
  private String orderId = "117938248";
  ...
  public void initializing() {
    ...
    currencyPairs.add(new CurrencyPair("BTC", "JPY"));
    currencyPairs.add(new CurrencyPair("ETH", "JPY"));
    currencyPairs.add(new CurrencyPair("ETH", "BTC"));

    ExchangeSpecification exchangesSpecifics = new ExchangeSpecification(CoincheckExchange.class);

    exchangesSpecifics.setSslUri("https://coincheck.jp");
    exchangesSpecifics.setUserName("tabtrader");
    exchangesSpecifics.setApiKey("YM3mtJlCw6uy_nT7");
    exchangesSpecifics.setSecretKey("Dn25JpznMJFwjdgJqErjIsbJtDdlaCGS");

    anyExchangeInstance = ExchangeFactory.INSTANCE.createExchange(exchangesSpecifics);
    //anyExchangeInstance=ExchangeFactory.INSTANCE.createExchange(CoincheckExchange.class.getName());
  ...
  public void placeSelLimitOrder() throws IOException {
    ...
    CurrencyPair currencyPair = new CurrencyPair("BTC","JPY");
    Order.OrderType orderType = Order.OrderType.ASK;
    BigDecimal tradableAmount = new BigDecimal("0.01");
    BigDecimal limitPrice = new BigDecimal("133400");
  ...
  public void placeBuyLimitOrder() throws IOException {
    ...
    BigDecimal tradableAmount = new BigDecimal("0.009");
    BigDecimal limitPrice = new BigDecimal("133600");
