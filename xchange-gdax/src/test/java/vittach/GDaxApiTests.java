...
public class GDaxApiTests {
  ...
  public void initializing() {
    ...
    ExchangeSpecification exchangesSpecifics = new ExchangeSpecification(GDAXExchange.class);

    exchangesSpecifics.setSslUri("https://api.gdax.com");
    ...
    anyExchangeInstance=ExchangeFactory.INSTANCE.createExchange(GDAXExchange.class.getName());
  ...
  public void getOrderInfo() throws IOException {
    ...
    TradeService marketDataService = anyExchangeInstance.getTradeService();
    GDAXOrder order = ((GDAXTradeServiceRaw) marketDataService).getOrder(orderId);
    result += " - getOrderInfo \n" + order + "\n";
  }
