...
public class GDAXMarketDataServiceRaw extends GDAXBasePollingService<GDAX> {
  ...
  public GDAXProductBook getCoinbaseExProductOrderBook(CurrencyPair currencyPair) throws IOException {
    ...
    GDAXProductBook book = this.coinbaseEx.getProductOrderBook(currencyPair.base.getCurrencyCode(),
            currencyPair.counter.getCurrencyCode(), "1");
    return book;
  }

  public GDAXProductBook getCoinbaseExProductOrderBook(CurrencyPair currencyPair, int level) throws IOException {
    GDAXProductBook book = this.coinbaseEx.getProductOrderBook(currencyPair.base.getCurrencyCode(),
            currencyPair.counter.getCurrencyCode(), String.valueOf(level));
    return book;
  }
