...
public class GDAXMarketDataService extends GDAXMarketDataServiceRaw implements PollingMarketDataService {
  ...
  public List<CurrencyPair> getExchangeSymbols() throws IOException {
    ...
    ArrayList<CurrencyPair> mySymbols = new ArrayList<>();
    List<GDAXProduct> products = coinbaseEx.getProducts();
    for (GDAXProduct gp : products) {
      mySymbols.add(new CurrencyPair(gp.toString()));
    }
    return mySymbols;
  }
