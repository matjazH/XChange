 ...
 */
public class CCexApiTests {
  private String result = "\n";
  private String orderId = "32806868";
  ...
  public void initializing() {
    ...
    ExchangeSpecification exchangesSpecifics = new ExchangeSpecification(CCEXExchange.class);

    exchangesSpecifics.setSslUri("https://c-cex.com");
    exchangesSpecifics.setUserName("tabtrader");
    exchangesSpecifics.setApiKey("96F68DD1520AA364F0BB363DD5E60E69");
    exchangesSpecifics.setSecretKey("DC8CA36DA7DFD2D63EA86709D8E4D84D");

    anyExchangeInstance = ExchangeFactory.INSTANCE.createExchange(exchangesSpecifics);
    //anyExchangeInstance=ExchangeFactory.INSTANCE.createExchange(CCEXExchange.class.getName());
  ...
  public void placeLimitOrder() throws IOException {
    ...
    BigDecimal tradableAmount = new BigDecimal(0.0001);
    BigDecimal limitPrice = new BigDecimal(99999);
    Date date = new Date();
  ...
  @Test
  public void getCCEXListInfo() throws IOException {
    try {
      Thread.sleep(1000);
    } catch (InterruptedException e) {
      e.printStackTrace();
    }
    result += " - getCCEXListInfo \n";
    List<CCEXMarket> info = ((CCEXMarketDataService) pollingMarketDataService).getAllCCEXInfo();
    for(CCEXMarket obj: info) {
      result += obj.toString();
    }
    result += "\n";
  }
