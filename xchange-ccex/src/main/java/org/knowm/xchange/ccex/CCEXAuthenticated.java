...
public interface CCEXAuthenticated extends CCEX {
  ...
  CCEXCancelResponse cancel(@PathParam("apikey") String apikey,
  ...
  @GET
  @Path("api.html?a=getorder&apikey={apikey}&nonce={nonce}&uuid={uuid}")
  CCEXGetorderinfoResponse getorderinfo(@PathParam("apikey") String apikey,
                                        @HeaderParam("apisign") ParamsDigest signature,
                                        @PathParam("nonce") SynchronizedValueFactory<Long> nonce,
                                        @PathParam("uuid") String uuid) throws IOException;
  ...
  CCEXBalanceResponse getdepositaddress(@PathParam("apikey") String apikey,
                                        @HeaderParam("apisign") ParamsDigest signature,
                                        @PathParam("nonce") SynchronizedValueFactory<Long> nonce,
  ...
  public CCEXBalancesResponse balances(@PathParam("apikey") String apikey,
                                       @HeaderParam("apisign") ParamsDigest signature,
  ...
  CCEXGetopenordersResponse getopenorders(@PathParam("apikey") String apikey,
                                          @HeaderParam("apisign") ParamsDigest signature,
                                          @PathParam("nonce") SynchronizedValueFactory<Long> nonce) throws IOException;

  @GET
  @Path("api.html?a=getorderhistory&apikey={apikey}&nonce={nonce}")
  CCEXGetorderhistoryResponse getorderhistory(@PathParam("apikey") String apikey,
                                              @HeaderParam("apisign") ParamsDigest signature,
                                              @PathParam("nonce") SynchronizedValueFactory<Long> nonce) throws IOException;
  ...
  CCEXBuySellLimitResponse buylimit(@PathParam("apikey") String apikey, @HeaderParam("apisign") ParamsDigest signature,
                                    @PathParam("nonce") SynchronizedValueFactory<Long> nonce,
                                    @PathParam("lmarket") String lmarket, @PathParam("rmarket") String rmarket,
