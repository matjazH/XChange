...
public class CCEXOrderInfo extends Order {
  ...
  public CCEXOrderInfo(
      ...
      @JsonProperty("CommissionReserveRemaining") BigDecimal сommissionReserveRemaining,
      ...
      @JsonProperty("ConditionTarget") String conditionTarget) throws ParseException {

    super(orderType.equals("sell")?Order.OrderType.ASK:Order.OrderType.BID,
        new BigDecimal(0),
        new CurrencyPair(exchange.replace("-", "/")),
        orderUuid, new SimpleDateFormat("yyyyMMdd").parse(opened));
    Limit = limit;
    Price = price;
    IsOpen = isOpen;
    Opened = opened;
    ...
    CommissionReserveRemaining = сommissionReserveRemaining;
  }
  ...
  public String toString() {
    return "CCEXOrderInfo [OrderUuid=" + OrderUuid + ", Exchange=" + Exchange + ", OrderType=" + OrderType
        ...
        + Condition + ", ConditionTarget=" + ConditionTarget + ", AccountId=" + AccountId + ", Reserved="
        + Reserved + ", ReserveRemaining=" + ReserveRemaining+ ", CommissionReserved=" +CommissionReserved
        + ", CommissionReserveRemaining=" + CommissionReserveRemaining + ",IsOpen="+ IsOpen+ ", Sentinel="
        + Sentinel + "]";
  }
}
