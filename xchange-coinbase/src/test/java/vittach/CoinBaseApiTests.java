...
public class CoinBaseApiTests {
  ...
  public void initializing() {
    ...
    ExchangeSpecification exchangesSpecifics = new ExchangeSpecification(CoinbaseExchange.class);

    exchangesSpecifics.setSslUri("https://coinbase.com");
    ...
    anyExchangeInstance=ExchangeFactory.INSTANCE.createExchange(CoinbaseExchange.class.getName());
